...
from app.forms import productForm, salesForm
from app.models import Products, Sales, Categories
from app import db
...
# def check_login():
#     if not current_user.is_authenticated and request.endpoint not in ['auth.login', 'static', 'auth.logout']:
